...
public class DoubleXLabelAxisRenderer extends XAxisRenderer {
    ...
    private final IAxisValueFormatter topValueFormatter;

    public DoubleXLabelAxisRenderer(ViewPortHandler viewPortHandler, XAxis xAxis,
                                    Transformer transformer, IAxisValueFormatter topValueFormatter) {
