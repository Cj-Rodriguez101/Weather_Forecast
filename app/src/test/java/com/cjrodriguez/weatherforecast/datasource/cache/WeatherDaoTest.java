...
public class WeatherDaoTest {
    ...
    //@Spy WeatherDao weatherDao;

    @Test
    public void testIfAllDataIsClearedOnTransaction_ExpectSuccess() {

        WeatherDao weatherDao = Mockito.spy(new WeatherDao() {
            @Override
    ...
    public void testAndGetCurrentWeatherData_ExpectSuccess() {
        ...
        //WeatherData weatherData = new WeatherData(new Location(TEST_CITY), null, null);
...
//        Mockito.when(weatherDao.getCurrentWeatherData(TEST_CITY)).thenReturn(weatherData);
